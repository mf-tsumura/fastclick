;(function () {
	...
	*/
	...
	FastClick.prototype.onTouchStart = function(event) {
		var targetElement, touch, selection, touchStartTime = (new Date()).getTime();
	...
	FastClick.prototype.onTouchEnd = function(event) {
		var forElement, trackingClickStart, targetTagName, scrollParent, touch, targetElement = this.targetElement, touchEndTime = (new Date()).getTime();
